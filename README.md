...
### Trabalhos de referência e baselines diretos

- **Lamkanfi, A., Demeyer, S., Giger, E., & Goethals, B.** (2010). *Predicting the severity of a reported bug*. In Proceedings of the 7th IEEE Working Conference on Mining Software Repositories (MSR 2010), pp. 1–10. — **Baseline central do trabalho.**

- **Menzies, T., & Marcus, A.** (2008). *Automated severity assessment of software defect reports*. In Proceedings of the IEEE International Conference on Software Maintenance (ICSM 2008), pp. 346–355.

- **Tian, Y., Lo, D., & Sun, C.** (2013). *DRONE: Predicting priority of reported bugs by multi-factor analysis*. In Proceedings of the 29th IEEE International Conference on Software Maintenance (ICSM 2013), pp. 200–209.

- **Umer, Q., et al.** (2019). *A novel deep-learning-based bug severity classification technique using CNN and Random Forest with boosting*. Sensors, 19(13), 2964. MDPI.

- **Ali, A., Xia, Y., Umer, Q., & Osman, M.** (2024). *BERT based severity prediction of bug reports for the maintenance of mobile applications*. Journal of Systems and Software, 207, 111898.

### Vulnerabilidades (segundo domínio)
...
- **Spanos, G., Angelis, L., & Toloudis, D.** (2017). *Assessment of vulnerability severity using text mining*. In Proceedings of the 21st Pan-Hellenic Conference on Informatics (PCI 2017). ACM.

### Fundamentos de ensemble e meta-learning

- **Wolpert, D. H.** (1992). *Stacked generalization*. Neural Networks, 5(2), 241–259. — **Referência original do Stacking.**

- **Dietterich, T. G.** (2000). *Ensemble methods in machine learning*. In Multiple Classifier Systems (MCS 2000), LNCS 1857, pp. 1–15. Springer.

- **Kuncheva, L. I.** (2014). *Combining Pattern Classifiers: Methods and Algorithms* (2nd ed.). Wiley.

### Modelos base não-sklearn

- **Chen, T., & Guestrin, C.** (2016). *XGBoost: A scalable tree boosting system*. In Proceedings of KDD 2016, pp. 785–794.

- **Ke, G., Meng, Q., Finley, T., Wang, T., Chen, W., Ma, W., … & Liu, T.-Y.** (2017). *LightGBM: A highly efficient gradient boosting decision tree*. In Advances in Neural Information Processing Systems (NeurIPS 2017), vol. 30, pp. 3149–3157.
...
- **Demšar, J.** (2006). *Statistical comparisons of classifiers over multiple data sets*. Journal of Machine Learning Research (JMLR), 7, 1–30. — **Justifica o uso de Friedman + Nemenyi.**
